...
namespace c__project1 {
    ...
    public partial class hardwarestoreDataSet : global::System.Data.DataSet {
        ...
        public partial class suppliersDataTable : global::System.Data.TypedTableBase<suppliersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public suppliersRow AddsuppliersRow(string Id, string fullname, int phone, string nic, string address, string email) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public suppliersRow FindByphone(int phone) {
        ...
        public partial class suppliersRow : global::System.Data.DataRow {
            ...
            public string fullname {
                get {
                    try {
                        return ((string)(this[this.tablesuppliers.fullnameColumn]));
                    }
                ...
                set {
                    this[this.tablesuppliers.fullnameColumn] = value;
                }
            }
            ...
            public string nic {
                get {
                    try {
                        return ((string)(this[this.tablesuppliers.nicColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'nic\' in table \'suppliers\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablesuppliers.nicColumn] = value;
                }
            }
            ...
            public bool IsfullnameNull() {
                return this.IsNull(this.tablesuppliers.fullnameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetfullnameNull() {
                this[this.tablesuppliers.fullnameColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public bool IsnicNull() {
                return this.IsNull(this.tablesuppliers.nicColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetnicNull() {
                this[this.tablesuppliers.nicColumn] = global::System.Convert.DBNull;
            }
...
namespace c__project1.hardwarestoreDataSetTableAdapters {
    ...
    public partial class suppliersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[suppliers] WHERE (([Id] = @Original_Id) AND ((@IsNull_fullname = 1 AND [fullname] IS NULL) OR ([fullname] = @Original_fullname)) AND ([phone] = @Original_phone) AND ((@IsNull_nic = 1 AND [nic] IS NULL) OR ([nic] = @Original_nic)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[suppliers] ([Id], [fullname], [phone], [nic], [address], [emai" +
                "l]) VALUES (@Id, @fullname, @phone, @nic, @address, @email);\r\nSELECT Id, fullnam" +
                "e, phone, nic, address, email FROM suppliers WHERE (phone = @phone)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[suppliers] SET [Id] = @Id, [fullname] = @fullname, [phone] = @phone, [nic] = @nic, [address] = @address, [email] = @email WHERE (([Id] = @Original_Id) AND ((@IsNull_fullname = 1 AND [fullname] IS NULL) OR ([fullname] = @Original_fullname)) AND ([phone] = @Original_phone) AND ((@IsNull_nic = 1 AND [nic] IS NULL) OR ([nic] = @Original_nic)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)));
SELECT Id, fullname, phone, nic, address, email FROM suppliers WHERE (phone = @phone)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=DESKTOP-RN86JLR\\SQLEXPRESS;Initial Catalog=hardwarestore;Integrated S" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, fullname, phone, nic, address, email FROM dbo.suppliers";
        ...
        public virtual int Fill(hardwarestoreDataSet.suppliersDataTable dataTable) {
        ...
        public virtual hardwarestoreDataSet.suppliersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            hardwarestoreDataSet.suppliersDataTable dataTable = new hardwarestoreDataSet.suppliersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(hardwarestoreDataSet.suppliersDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Id, string Original_fullname, int Original_phone, string Original_nic, string Original_address, string Original_email) {
            if ((Original_Id == null)) {
        ...
        public virtual int Insert(string Id, string fullname, int phone, string nic, string address, string email) {
            if ((Id == null)) {
        ...
        public virtual int Update(string Id, string fullname, int phone, string nic, string address, string email, string Original_Id, string Original_fullname, int Original_phone, string Original_nic, string Original_address, string Original_email) {
            if ((Id == null)) {
                throw new global::System.ArgumentNullException("Id");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Id, string fullname, string nic, string address, string email, string Original_Id, string Original_fullname, int Original_phone, string Original_nic, string Original_address, string Original_email) {
            return this.Update(Id, fullname, Original_phone, nic, address, email, Original_Id, Original_fullname, Original_phone, Original_nic, Original_address, Original_email);
        }
    }
